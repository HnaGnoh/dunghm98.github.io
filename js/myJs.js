...
function firstQuestion(){
    ...
    $('.content').hide();
    Swal.fire({
        title: 'Ano Ẻm kutee ❤️!',
        text: 'Mình có điều này muốn hỏi bạn á nhớ phải trả lời thật lòng nhaaa.',
...
$('#yes').click(function() {
    ...
    audio.play();
    Swal.fire({
        title: 'Nói cho t lí do mài thích t đi :vvvv',
        html: true,
        width: 900,
        padding: '3em',
        ...
        confirmButtonText: 'Gửi cho me <3'
    }).then((result) => {
        if (result.value) {
            Swal.fire({
                width: 900,
                ...
                onClose: () => {
                    window.location = 'http://facebook.com/LT.HongAnh.269';
                  }
            })
        }
    })
